...
$query_get_bm = " SELECT DISTINCT tb_bahan_sj.code_item AS code_item,tb_bahan_sj.code_bahan as code_bahan ,tb_bahan_sj.qty as qty,tb_bahan_mentah.item as item,tb_bahan_mentah.unit as unit , tb_cogs_bm.reference_cost_unit as reference_cost,tb_cogs_bm.average_cost_unit as average_cost , tb_cogs_bm.last_buy_unit as lastbuy_cost FROM `tb_bahan_sj` inner JOIN tb_bahan_mentah ON tb_bahan_sj.code_bahan = tb_bahan_mentah.code_item inner JOIN tb_cogs_bm ON tb_bahan_sj.code_bahan = tb_cogs_bm.code_item WHERE tb_bahan_sj.code_item ='" . $code_item . "'";
