...
if (mysqli_num_rows($result) > 0) {
    // !Update Menu!
    $query_update_menu = "UPDATE tb_cogs_bm SET periode='" . $periode . "',reference_cost='" . $reference_cost . "',average_cost='" . $average_cost . "',last_buy_cost='" . $lastbuy_cost . "',reference_cost_unit='" . $reference_cost . "',average_cost_unit='" . $average_cost . "',last_buy_unit = '" . $lastbuy_cost . "' where code_item='" . $code_item . "'";
    ...
    $query_insert = "INSERT INTO tb_cogs_bm set uuid= uuid(), periode='" . $periode . "', code_item='" . $code_item . "',reference_cost='" . $reference_cost . "',average_cost='" . $average_cost . "',last_buy_cost='" . $lastbuy_cost . "',reference_cost_unit='".$reference_cost."',average_cost_unit='".$average_cost."',last_buy_unit='".$lastbuy_cost."'";
